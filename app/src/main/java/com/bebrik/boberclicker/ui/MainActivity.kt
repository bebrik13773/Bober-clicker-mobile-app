...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupNavigation() {
        ...
        binding.btnMinigame.setOnClickListener     { startActivity(Intent(this, MiniGameActivity::class.java)) }
    ...
    private fun showAchievementToast(text: String) {
        ...
        binding.tvAchievementToast.animate().alpha(1f).setDuration(300).withEndAction {
            binding.tvAchievementToast.animate().alpha(0f).setStartDelay(2000).setDuration(500)
                .withEndAction { binding.tvAchievementToast.visibility = View.GONE }.start()
        }.start()
    }
